            ...
            {phase === "pergunta" && (
                <div>
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 gap-5 p-6">
                        <p
                            onClick={() =>
                                checkAnswer(shuffledQuestions[currentQuestion].options[0])
                            }
                            className="bg-blue-700 rounded-2xl p-6 text-white font-sans cursor-pointer"
                        >
                            A: {shuffledQuestions[currentQuestion].options[0]}
                        </p>

                        <p
                            onClick={() =>
                                checkAnswer(shuffledQuestions[currentQuestion].options[1])
                            }
                            className="bg-blue-700 rounded-2xl p-6 text-white font-sans cursor-pointer"
                        >
                            B: {shuffledQuestions[currentQuestion].options[1]}
                        </p>

                        <p
                            onClick={() =>
                                checkAnswer(shuffledQuestions[currentQuestion].options[2])
                            }
                            className="bg-blue-700 rounded-2xl p-6 text-white font-sans cursor-pointer"
                        >
                            C: {shuffledQuestions[currentQuestion].options[2]}
                        </p>

                        <p
                            onClick={() =>
                                checkAnswer(shuffledQuestions[currentQuestion].options[3])
                            }
                            className="bg-blue-700 rounded-2xl p-6 text-white font-sans cursor-pointer"
                        >
                            D: {shuffledQuestions[currentQuestion].options[3]}
                        </p>
                    </div>
                </div>
            )}
